...
// vector * scalar
internal operator fun List<Double>.times(scalar: Double): List<Double> = this.map { it * scalar }

// scalar * vector
internal operator fun Double.times(vector: List<Double>): List<Double> = vector.times(this)